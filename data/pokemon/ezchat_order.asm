...
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, GEKKOU, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ri:       db WIZARDON, CHARIZARD, URSARING, -1
.ru:       db JYNX, LUGIA, -1
