...
; values are indexes for Roofs (see below)
	...
	db -1                  ; 17
	db -1                  ; 18
	db ROOF_MYSTIE_FOREST  ; 19 (Silver Cave)
	db -1                  ; 20
	db -1                  ; 21
	db ROOF_OLIVINE        ; 22 (Cianwood)
	db -1                  ; 23
	db ROOF_MYSTIE_FOREST  ; 24 (Mystie Forest)
	db -1                  ; 25
	db ROOF_MYSTIE_FOREST  ; 26 (Cherrygrove)
	assert_table_length NUM_MAP_GROUPS + 1

Roofs:
; entries correspond to ROOF_* constants
	table_width ROOF_LENGTH * LEN_2BPP_TILE, Roofs
INCBIN "gfx/tilesets/roofs/mystie_forest.2bpp"
