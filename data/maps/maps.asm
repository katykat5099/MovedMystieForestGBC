...
MapGroup_MystieForestVillageArea:
	...
	map TowerOne, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TowerTwo, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ThreeTowersConnect, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
    map EldersTower, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MystieForestVillage, TILESET_MYSTIE_FOREST, TOWN, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map EldersTowerIndoor, TILESET_MYSTIE_TOWERS, INDOOR, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PlayersHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EldersTowerIndoorTwo, TILESET_MYSTIE_TOWERS, INDOOR, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
