...
MapGroup_MystieForestVillageArea:
	...
	map TowerOne, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TowerTwo, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ThreeTowersConnect, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
    map EldersTower, TILESET_MYSTIE_FOREST, ROUTE, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MystieForestVillage, TILESET_MYSTIE_FOREST, TOWN, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map EldersTowerIndoor, TILESET_MYSTIE_TOWERS, INDOOR, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EldersTowerIndoorTwo, TILESET_MYSTIE_TOWERS, INDOOR, LANDMARK_MYSTIE_FOREST_VILLAGE, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TowerOneIndoorF1, TILESET_MYSTIE_TOWERS, INDOOR, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TowerOneBasement, TILESET_MYSTIE_TOWERS, DUNGEON, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_NONE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map Route27SandstormHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_27, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route29Route46Gate, TILESET_GATE, GATE, LANDMARK_MYSTIE_FOREST_TOWERS, MUSIC_ROUTE_29, FALSE, PALETTE_DAY, FISHGROUP_SHORE
