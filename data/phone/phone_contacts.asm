...
; entries correspond to PHONE_* constants
	...
	phone TRAINER_NONE, PHONECONTACT_MOM,      PLAYERS_HOUSE,             ANYTIME, MomPhoneCalleeScript,     0,       UnusedPhoneScript
	phone TRAINER_NONE, PHONECONTACT_BIKESHOP, OAKS_LAB,                  0,       UnusedPhoneScript,        0,       UnusedPhoneScript
	phone TRAINER_NONE, PHONECONTACT_BILL,     N_A,                       ANYTIME, BillPhoneCalleeScript,    0,       BillPhoneCallerScript
	phone TRAINER_NONE, PHONECONTACT_ELM,      ELDERS_TOWER_INDOOR,       ANYTIME, ElmPhoneCalleeScript,     0,       ElmPhoneCallerScript
	...
	phone YOUNGSTER,    JOEY1,                 ROUTE_31,                  ANYTIME, JoeyPhoneCalleeScript,    ANYTIME, JoeyPhoneCallerScript
