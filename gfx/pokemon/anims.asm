...
WizardonAnimation:   INCLUDE "gfx/pokemon/wizardon/anim.asm"
TaladonAnimation:    INCLUDE "gfx/pokemon/taladon/anim.asm"
GekklodonAnimation:  INCLUDE "gfx/pokemon/gekklodon/anim.asm"
...
RatskullAnimation:   INCLUDE "gfx/pokemon/ratskull/anim.asm"
